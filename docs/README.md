...
项目文档目录。
包含架构、字段字典、工具指南、测试计划等。

## 文档分区

- [architecture](architecture): 架构方案与系统设计文档
- [data-dictionary](data-dictionary): 配置字段与数据字典
- [tool-guides](tool-guides): 工具链与开发流程文档
- [test-plan](test-plan): 测试策略与验收计划
